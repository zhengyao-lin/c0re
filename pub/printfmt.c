 ...
 * */
static void
printnum(putc_fn_t putch, void *putdat,
 ...
 * */
void
printfmt(putc_fn_t putch, void *putdat, const char *fmt, ...)
{
    va_list ap;
 ...
 * */
void
vprintfmt(putc_fn_t putch, void *putdat, const char *fmt, va_list ap)
{
